...
@section('page-title', 'Tambah Mandor')
@section('page-subtitle', 'Daftarkan akun mandor baru')
...
<div class="max-w-xl mx-auto">
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-violet-600 px-6 py-5">
            <h2 class="text-lg font-bold text-white">Form Tambah Mandor</h2>
            <p class="text-indigo-100 text-sm mt-1">Mandor dapat mengakses laporan dan data produksi, namun hanya dapat melihat gambar kerja</p>
        </div>

        <form method="POST" action="{{ route('mandors.store') }}" class="p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       placeholder="Nama lengkap mandor"
            ...
            <div class="flex gap-3 pt-2">
                ...
                <button type="submit"
                        class="flex-1 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold transition-colors">
                    Simpan Mandor
                </button>
            </div>
        </form>
